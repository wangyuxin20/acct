...
public class Kq2055 {
	...
	private static String FRZ_FLOW_ID = "0";  // 外部扩展无法获取支付凭证，设置为0
	private static String STAGE = "0";        // 是否预约（0：否，1：是）
	private static String CHANNEL = "0";   //0：外部渠道
	private static String UNFRZ_AMT = "10000";
	private static String CURR_NO = "RMB";
	...
	public static void main(String[] args) {
		...
		kq1.setCoAssetId("1");
		kq1.setExpire("20180221");
		kq1.setMerNo("SH00000555");
		kq1.setMerName("联名卡券商户555");
		kq1.setExCode("KQ123123");
		kq1.setExName("123123卡券");
		kq1.setExNum("1");
		kq1.setExPrice("600");
		kq1.setSettleAmt("600");
		kq1.setSettleType("1");
		kq1.setTranCode("1");
		
		CardJointlyKq kq2 = new CardJointlyKq();
		kq2.setCoAssetId("2");
		kq2.setExpire("20180222");
		kq2.setMerNo("SH00000666");
		kq2.setMerName("联名卡券商户666");
		...
		CardJointlyKq kq3 = new CardJointlyKq();
		kq3.setCoAssetId("3");
		kq3.setExpire("20180302");
		kq3.setMerNo("SH00000777");
		kq3.setMerName("联名卡券商户777");
		kq3.setExCode("KQ234234");
		kq3.setExName("234234卡券");
		kq3.setExNum("1");
		kq3.setExPrice("0");
		kq3.setSettleAmt("0");
		kq3.setSettleType("2");
